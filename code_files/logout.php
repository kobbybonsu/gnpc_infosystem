      ...
      <form method="POST" action="index_json_response.php?cmd=1" class="login-form">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <center><h3 style="color:black;">Information Management System</h3></center>
            </div>
            <!-- <div class="col-lg-4">
            </div> -->
        </div>  
        <div class="login-wrap">
            ...
            <br>
            <font style="color:red; size:16px;"><center>You've been logged out! : Inactive Session</center></font>
        </div>
      </form>
